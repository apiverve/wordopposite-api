...
```gradle
dependencies {
    implementation 'com.github.apiverve:wordopposite-api:1.1.13'
}
```
...
```java
import com.apiverve.wordopposite.WordOppositesAPIClient;
import com.apiverve.wordopposite.APIResponse;
import com.apiverve.wordopposite.APIException;

// Initialize the client
WordOppositesAPIClient client = new WordOppositesAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("word", "hot");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/wordopposite](https://docs.apiverve.com/ref/wordopposite)
...
- **Documentation:** [https://docs.apiverve.com/ref/wordopposite](https://docs.apiverve.com/ref/wordopposite)
- **Issues:** [GitHub Issues](https://github.com/apiverve/wordopposite-api/issues)
