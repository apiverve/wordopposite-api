/*
 * Word Opposites API - Basic Usage Example
 *
 * This example demonstrates the basic usage of the Word Opposites API.
 * API Documentation: https://docs.apiverve.com/ref/wordopposite
 */
...
{
    class WordOppositesExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/wordopposite";

        /// <summary>
        /// Make a GET request to the Word Opposites API
        /// </summary>
        static async Task<JsonDocument> CallWordOppositesAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;word&quot;] &#x3D; &quot;hot&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Word Opposites API...\n");

            var result = await CallWordOppositesAPI();
