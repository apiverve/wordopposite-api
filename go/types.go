...
// Request contains the parameters for the Word Opposites API.
//
// Parameters:
...
// ResponseData contains the data returned by the Word Opposites API.
type ResponseData struct {
	Word string `json:"word"`
	Opposites []string `json:"opposites"`
}
