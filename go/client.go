// Package wordopposite provides a Go client for the Word Opposites API.
//
// For more information, visit: https://apiverve.com/marketplace/wordopposite?utm_source=go&utm_medium=readme
package wordopposite
...
const (
	baseURL        = "https://api.apiverve.com/v1/wordopposite"
	defaultTimeout = 30 * time.Second
)

// Client is the Word Opposites API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Word Opposites API client.
...
// Execute makes a request to the Word Opposites API with typed parameters.
//
...
//   - word (required): string - The word to get the opposites for
